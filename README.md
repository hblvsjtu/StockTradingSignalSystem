...
### [3.1 MACD](#3.1) 
### [3.2 CCI](#3.2)
### [3.3 运用BOLL,CCI和MACD多系统操作策略](#3.3)
...
<h3 id='3.3'>3.3 运用BOLL,CCI和MACD多系统操作策略</h3>  
...
#### 4) 买卖时机 
> - 交易日下午2：50是否出现股灾，如果出现股灾，使用CCI专家系统，
> - 没有出现股灾的时候
>> - 第一个买进信号，使用BOLL系统
...
> - 出现股灾的时候
>> - 不管前面的所有信号和买卖情况，采用使用CII系统，只要出现一个买进信号，就买进抄底，最多抄底两次，然后就等待卖出；
>> - 第一个卖出信号，使用BOLL系统，只要出现而且有盈利的情况下，应该全盘卖出；
#### 5) 沙盘推演
