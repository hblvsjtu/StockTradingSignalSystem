...
#### 6) 单边牛市向上的时候
> - 如果空仓而且距离上次买入超过一个月的时候应该买进一份网格；
> - 然后运用MACD系统等待卖出信号
> - 等待上次MACD系统卖出信号发出后空仓半个月内不准买卖，观察日线，10日线，20日线，如果均线开始向下，则认为结束牛市；如果均线没有向下，则继续观察，若第15-30天内均线依然不动如山或者向上，说明筑底成功，应该买入一网格作为试探，如果在第15-30天内此起彼伏或者向下，则认为要继续下探；
#### 7) 单边牛市向下的时候
